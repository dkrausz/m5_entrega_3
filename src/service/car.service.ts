...
import { ICarService, TCar, TCreateCarBody, TUpdateCarBody } from "../interfaces/car.interface";
import { carScherma, createCarBodySchema } from "../schemas/car.schema";
...
export class CarService implements ICarService{
    ...
    public getCars = async():Promise<Array<TCar>>=>{
    ...
    public updateCar = async(id:string, payload:TUpdateCarBody):Promise<TCar>=>{
        const updatedCar = await prisma.car.update({where:{id},data:payload});
